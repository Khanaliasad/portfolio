...
const About = ({ pageInfo }: Props) => {
  return (
    ...
    >
      ...
      {/* <Image></Image> */}
      <div className="flex flex-col items-center justify-center md:flex-row md:justify-around md:items-start sm:gap-10">
        <motion.div
          initial={{
            x: -200,
            opacity: 0,
        ...
        >
          ...
          <div className="rounded-full object-cover md:rounded-lg  w-56 h-56 md:w-64 md:h-96 xl:w-[400px] xl:h-[500px]">
